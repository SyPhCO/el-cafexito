...
class LetCommentController extends AbstractController
{
    ...
    public function index(Request $request, SluggerInterface $slugger): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $notification =  "Merci de votre retour.
            Avant publication je me dois de vérifier chaque commentaire pour validation afin de ne pas retrouver de propos offensant ou insultant.";
        }

        return $this->render('account/let_comment.html.twig', [
