...
class __TwigTemplate_21d69c51b3b35bacffb7a4e1dd38ffb1 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "user", [], "any", false, false, false, 11)) {
            // line 12
            echo "        <div class=\"mb-3\">
            Vous etes connecté avec le compte de  ";
            // line 13
    ...
    ";
        ...
        // line 16
        echo "
    <h1 class=\" mb-3 mt-5 font-weight-normal text-center\">Merci de vous connecter</h1>
    ...
    <input type=\"email\" value=\"";
        ...
        echo "\" name=\"email\" id=\"inputEmail\" class=\"form-control mb-4\" autocomplete=\"email\" placeholder=\"Saisissez votre email\" required autofocus>
    ...
    <button class=\"btn btn-lg btn-info btn-block mt-3 mb-5\" type=\"submit\">
        connexion
    </button>
</form>
";
...
{% block title %}Se connecter - El Cafexito {% endblock %}
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous etes connecté avec le compte de  {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Deconnexion</a>
        </div>
    {% endif %}

    <h1 class=\" mb-3 mt-5 font-weight-normal text-center\">Merci de vous connecter</h1>
    <label for=\"inputEmail\">Votre email</label>
    <input type=\"email\" value=\"{{ last_username }}\" name=\"email\" id=\"inputEmail\" class=\"form-control mb-4\" autocomplete=\"email\" placeholder=\"Saisissez votre email\" required autofocus>
    <label for=\"inputPassword\">Votre mot de passe</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" autocomplete=\"current-password\" placeholder=\"Saisissez votre mot de passe\" required>
...
{% endblock %}
", "security/login.html.twig", "C:\\wamp64\\www\\el-cafexito\\templates\\security\\login.html.twig");
    }
}
