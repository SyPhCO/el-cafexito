...
class __TwigTemplate_74060bef0c25dccd66f4894d7085a4b1 extends Template
{
    private $source;
    private $macros = [];
                            ...
                            {% for trace in client.traces %}
                                ...
                                <table class=\"sf-profiler-httpclient-requests\">
                                    ...
                                    <tr>
                                        ...
                                        {% if profiler_token and profiler_link %}
                                            <td>
                                                <span><a href=\"{{ profiler_link }}\" rel=\"noopener\"  target=\"_blank\">{{ profiler_token }}</a></span>
                                            </td>
                                        {% endif %}
                                    </tr>
                                    </tbody>
...
{% endblock %}
", "@WebProfiler/Collector/http_client.html.twig", "C:\\wamp64\\www\\el-cafexito\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\http_client.html.twig");
    }
}
